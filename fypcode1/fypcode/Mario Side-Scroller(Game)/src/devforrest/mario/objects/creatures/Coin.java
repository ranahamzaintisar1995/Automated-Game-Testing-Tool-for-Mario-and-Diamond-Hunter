...
public class Coin extends Creature {
	...
	public Coin(int pixelX, int pixelY) {
		...
		//writer.WriteToFile("Coin::Coin(int pixelX, int pixelY)");
		...
		final class DeadAfterAnimation extends Animation {
			public void endOfAnimationAction() {
				...
				//writer.WriteToFile("Coin::DeadAfterAnimation::endOfAnimationAction()");
...
//	}
	...
	public void updateCreature(TileMap map, int time) {
		...
		//writer.WriteToFile("Coin::updateCreature(TileMap map, int time)");
