...
public class RedShell extends Creature {
	...
	public RedShell(int x, int y, TileMap map, MarioSoundManager22050Hz soundManager, boolean isStill) {
		...
		//writer.WriteToFile("RedShell::RedShell(int x, int y, TileMap map, MarioSoundManager22050Hz soundManager, boolean isStill)");
		...
		final class DeadAfterAnimation extends Animation {
			public void endOfAnimationAction() {
				//writer.WriteToFile("RedShell::DeadAfterAnimation::endOfAnimationAction()");
				kill();
			}
		}
	...
	public boolean isMoving() {
		//writer.WriteToFile("RedShell::boolean isMoving()");
		return isMoving;
	}
	
	public void xCollide(Point p) {
		//writer.WriteToFile("RedShell::xCollide(Point p)");
		super.xCollide(p);
	...
	public void flip() {
		//writer.WriteToFile("RedShell::flip()");
		setAnimation(flip);
		setIsFlipped(true);
	...
	public void jumpedOn(boolean fromRight, float attackerSpeed) {
		...
		//writer.WriteToFile("RedShell::jumpedOn(boolean fromRight, float attackerSpeed)");
