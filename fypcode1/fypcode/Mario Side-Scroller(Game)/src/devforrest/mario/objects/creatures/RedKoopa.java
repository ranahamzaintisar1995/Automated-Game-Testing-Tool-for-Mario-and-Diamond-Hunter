...
public class RedKoopa extends Creature {
	...
	public RedKoopa(int x, int y, MarioSoundManager22050Hz soundManager) {
		...
		//writer.WriteToFile("RedKoopa::RedKoopa(int x, int y, MarioSoundManager22050Hz soundManager)");
		...
		final class DeadAfterAnimation extends Animation {
			public void endOfAnimationAction() {
				//writer.WriteToFile("RedKoopa::DeadAfterAnimation::endOfAnimationAction()");
	...
	public void xCollide(Point p) {
		...
		//writer.WriteToFile("RedKoopa::xCollide(Point p)");
	...
	public void creatureXCollide() {
		...
		//writer.WriteToFile("RedKoopa::creatureXCollide()");
	...
	public void flip() {
		//writer.WriteToFile("RedKoopa::flip()");
		setAnimation(flip);
		setIsFlipped(true);
	...
	public void wakeUp() {
		//writer.WriteToFile("RedKoopa::wakeUp()");
		super.wakeUp();
	...
	public void jumpedOn() {
		//writer.WriteToFile("RedKoopa::jumpedOn()");
		setAnimation(dead);
		setIsCollidable(false);
		dx = 0;
	}
