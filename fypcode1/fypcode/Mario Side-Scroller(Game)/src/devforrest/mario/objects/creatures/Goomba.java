...
public class Goomba extends Creature {
	...
	public Goomba(int x, int y, MarioSoundManager22050Hz soundManager) {
		...
		//writer.WriteToFile("Goomba::Goomba(int x, int y, MarioSoundManager22050Hz soundManager)");
		...
		final class DeadAfterAnimation extends Animation {
			public void endOfAnimationAction() {
				...
				//writer.WriteToFile("Goomba::DeadAfterAnimation::endOfAnimationAction()");
				kill();
			}
		}
	...
	public void wakeUp() {
		//writer.WriteToFile("Goomba::wakeUp()");
	...
	public void jumpedOn() {
		//writer.WriteToFile("Goomba::jumpedOn()");
	...
	public void flip() {
		//writer.WriteToFile("Goomba::flip()");
