...
public class SlopedTile extends GameTile {
	...
	public SlopedTile(int pixelX, int pixelY, BufferedImage img, boolean hasPositiveSlope) {
		...
		//writer.WriteToFile("SlopedTile::SlopedTile(int pixelX, int pixelY, BufferedImage img, boolean hasPositiveSlope)");
	...
	public Point getStartingPoint() {
		//writer.WriteToFile("SlopedTile::Point getStartingPoint()");
		return startingPoint;
	}
	
	public Point getEndingPoint() {
		//writer.WriteToFile("SlopedTile::Point getEndingPoint()");
		return endingPoint;
	}
	
	public boolean hasPositiveSlope() {
		//writer.WriteToFile("SlopedTile::boolean hasPositiveSlope()");
		return hasPositiveSlope;
	}
	
	private int correlateY(float pixelX) {
		//writer.WriteToFile("SlopedTile::int correlateY(float pixelX)");
	...
	private int correlateX(float pixelY) {
		//writer.WriteToFile("SlopedTile::int correlateX(float pixelY)");
	...
	public Point isWithin(float pixelX, float pixelY, float deltaX, float deltaY) {
		//writer.WriteToFile("SlopedTile::Point isWithin(float pixelX, float pixelY, float deltaX, float deltaY)");
