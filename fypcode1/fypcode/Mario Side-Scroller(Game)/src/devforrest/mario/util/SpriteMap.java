...
public class SpriteMap {
    ...
    public SpriteMap(String filename, int c, int r) {
    	////writer.WriteToFile("SpriteMap::SpriteMap(String filename, int c, int r)");
        this.loadSprites(filename, c, r);
    }
    
    // returns the sprites array
	public BufferedImage[] getSprites() {
		////writer.WriteToFile("SpriteMap::BufferedImage[] getSprites()");
		return sprites;
	}
    ...
    private void loadSprites(String filename, int c, int r) {
    	////writer.WriteToFile("SpriteMap::loadSprites(String filename, int c, int r)");
	...
	private BufferedImage loadImage(String ref) {   
		////writer.WriteToFile("SpriteMap::BufferedImage loadImage(String ref)");
	...
	private BufferedImage[] splitSprites(int c, int r) {
		//writer.WriteToFile("SpriteMap::BufferedImage[] splitSprites(int c, int r)");
