...
public class ImageManipulator {
	...
	public static BufferedImage loadImage(String filename) {
		...
		//writer.WriteToFile("ImageManipulator::BufferedImage loadImage(String filename)");
	...
	public static BufferedImage horizontalFlip(BufferedImage img) {   
		//writer.WriteToFile("ImageManipulator::BufferedImage horizontalFlip(BufferedImage img)");
        int w = img.getWidth();   
        int h = img.getHeight();   
	...
	public static BufferedImage verticalFlip(BufferedImage img) {  
		//writer.WriteToFile("ImageManipulator::BufferedImage verticalFlip(BufferedImage img)");
        int w = img.getWidth();   
        int h = img.getHeight();   
        BufferedImage dimg = new BufferedImage(w, h, img.getColorModel().getTransparency());   
        Graphics2D g = dimg.createGraphics();   
