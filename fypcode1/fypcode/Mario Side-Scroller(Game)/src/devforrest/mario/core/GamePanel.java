...
import devforrest.mario.objects.mario.TestingFlags;
...
public class GamePanel extends JPanel implements Runnable {
	...
	public GamePanel(int w, int h) {
		...
		//writer.WriteToFile("GamePanel::GamePanel(int w, int h)");
	...
	public void addNotify() {
		...
		//writer.WriteToFile("GamePanel::addNotify()");
	...
	private void startGame() {
		//writer.WriteToFile("GamePanel::startGame()");
	...
	public void stopGame() { 
		//writer.WriteToFile("GamePanel::stopGame()");
		running = false; }
	...
	public void gameAction() {
		...
		//writer.WriteToFile("GamePanel::gameAction()");
	...
	public void run() {
		...
		//writer.WriteToFile("GamePanel::run()");
	...
	private void gameUpdate() {
		...
		//writer.WriteToFile("GamePanel::gameUpdate()");
	...
	private void gameRender() {
		...
		//writer.WriteToFile("GamePanel::gameRender()");
	...
	private void paintScreen() {
		//writer.WriteToFile("GamePanel::paintScreen()");
	...
	class GameListener extends KeyAdapter {
	    ...
	    public void keyReleased(KeyEvent e) {
	    	...
	    	//writer.WriteToFile("GamePanel::GameListener::keyReleased(KeyEvent e)");
	        ...
	        if (key == KeyEvent.VK_Z) { // pause
		      ...
		      //  	TestingFlags.isPaused=true;
/*		        	System.out.print("TestingFlags.isPaused: "+TestingFlags.isPaused);
		        	try {
						Thread.sleep(50);
	    ...
	    public void keyPressed(KeyEvent e) {
	    	...
	    	//writer.WriteToFile("GamePanel::GameListener::keyPressed(KeyEvent e)");
