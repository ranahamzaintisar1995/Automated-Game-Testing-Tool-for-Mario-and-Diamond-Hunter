...
public class GameLoader {
	...
	public GameLoader() {
		...
		//writer.WriteToFile("GameLoader::GameLoader()");
    ...
    public TileMap loadOtherMaps(String filename) throws IOException {
    	...
    	//writer.WriteToFile("GameLoader::TileMap loadOtherMaps(String filename)");
	...
	public TileMap loadMap(String filename, MarioSoundManager22050Hz soundManager) throws IOException {
		...
		//writer.WriteToFile("GameLoader::TileMap loadMap(String filename, MarioSoundManager22050Hz soundManager)");
