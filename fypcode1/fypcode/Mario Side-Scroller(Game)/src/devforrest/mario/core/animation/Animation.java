...
public class Animation {
	...
	public Animation() {
		...
		//writer.WriteToFile("Animation::Animation()");
	...
	public Animation(long defaultAnimLength) {
		//writer.WriteToFile("Animation::Animation(long defaultAnimLength)");
	...
	public Animation setDAL(long defaultAnimLength) {
		//writer.WriteToFile("Animation::Animation setDAL(long defaultAnimLength)");
	...
	public Animation addFrame(BufferedImage image) {
		//writer.WriteToFile("Animation::Animation addFrame(BufferedImage image)");
	...
	public Animation addFrame(BufferedImage image, long duration) {
		//writer.WriteToFile("Animation::Animation addFrame(BufferedImage image, long duration)");
	 ...
	 */
	public void start() {
		//writer.WriteToFile("Animation::start()");
	...
	public int getHeight() {
		//writer.WriteToFile("Animation::int getHeight()");
	 ...
	 */
	public int getWidth() {
		//writer.WriteToFile("Animation::int getWidth()");
    ...
    public void update(long elapsedTime) {
    	...
    	//writer.WriteToFile("Animation::update(long elapsedTime)");
     ...
     */
    public void endOfAnimationAction() { //writer.WriteToFile("Animation::endOfAnimationAction()");
    	}
    ...
    private BufferedImage[] getImages() {
    	...
    	//writer.WriteToFile("Animation::BufferedImage[] getImages()");
    ...
    public BufferedImage getImage() {
    	...
    	//writer.WriteToFile("Animation::BufferedImage getImage()");
    ...
    private AnimFrame getFrame(int i) {
    	//writer.WriteToFile("Animation::AnimFrame getFrame(int i)");
    ...
    private class AnimFrame {
        ...
        public AnimFrame(BufferedImage image, long endTime) {
        	...
        	//writer.WriteToFile("Animation::AnimFrame::AnimFrame(BufferedImage image, long endTime)");
